...
from app.api.routes import auth, community, dashboard, detection, notifications, social, users, team, ponds, chatbot, behavior_anomaly
...
app.include_router(behavior_anomaly.router, prefix="/api")
